...
The wire format between the two packages — every message, how a capture is
correlated, and the framing and font constraints that make images work — is
documented in [`PROTOCOL.md`](PROTOCOL.md). Change it and both repositories have
to move together.
